...
function doLoad(theTexture, theImage) {
    ...
    if(curTexture != "proc"){
      ...
      gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA,3,12,0,gl.RGBA, gl.UNSIGNED_BYTE, new Uint8Array([255,0,0,255,240, 117, 10,255,255,255,0,255,0,255,0,255,0,0,255,255,255,255,0,255,
        255,0,0,255,240, 117, 10,255,255,255,0,255,0,255,0,255,0,0,255,255,255,255,0,255,
        255,0,0,255,240, 117, 10,255,255,255,0,255,0,255,0,255,0,0,255,255,255,255,0,255,
        255,0,0,255,240, 117, 10,255,255,255,0,255,0,255,0,255,0,0,255,255,255,255,0,255,
        255,0,0,255,240, 117, 10,255,255,255,0,255,0,255,0,255,0,0,255,255,255,255,0,255,
        255,0,0,255,240, 117, 10,255,255,255,0,255,0,255,0,255,0,0,255,255,255,255,0,255]));
...
function setUpTextures(){
    ...
    if(curTexture == "globe"){
      worldImage.src = 'https://raw.githubusercontent.com/bhushanbpatil/bhushanbpatil.github.io/main/1_earth_16k.jpg';
    }
    else if(curTexture == "myimage"){
      worldImage.src = "https://raw.githubusercontent.com/bhushanbpatil/bhushanbpatil.github.io/main/marsmap1k.jpg";
    }
    else{
      worldImage.src = "https://raw.githubusercontent.com/bhushanbpatil/bhushanbpatil.github.io/main/marsmap1k.jpg";
    }
