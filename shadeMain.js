...
function setUpPhong(program) {
    ...
    gl.uniform3f(program.baseColor, 1,0.0,0.0);
    gl.uniform1f(program.ka, 1.0);
    gl.uniform1f(program.ks, 1.0);
    gl.uniform1f(program.kd, 1.1);
    gl.uniform1f(program.ke, 10.0);
    gl.uniform3f(program.specHighlightColor, 1,1,1);
    gl.uniform3f(program.lightPosition, 15,-20,-1);
    gl.uniform3f(program.lightColor, 1,1,1);
    gl.uniform3f(program.ambientLight, 0.3,0.3,.3);
...
function setUpCamera(program) {
    ...
    glMatrix.mat4.ortho(projMatrix, -1, 1, -1, 1, 1.0, 300.0);
